        ...
        <div style="width: 480px;border: 0px solid red;justify-content: center;padding-bottom: 20px;min-height:140px;"  >
          <div>
            ...
            <div class="afal_main" style="width: 480px;min-height: 140px;">
              ...
              <div class="afal_line1"   style="margin-left: 20px;margin-top: 0px;">
                <div class="afal_title1" style="width: 120px;"> <span>*</span>多媒体类型：</div>
                <div class="afal_content1">
                  <el-checkbox-group v-model="obj.multiMediaType">
                    <el-checkbox  false-label='null' true-label="1" name="state">图片</el-checkbox>
                    <el-checkbox  false-label='null' true-label="2" name="state">音频</el-checkbox>
                    <el-checkbox  false-label='null' true-label="3" name="state">视频</el-checkbox>
                  </el-checkbox-group>
                </div>
              </div>

              <div class="afal_line1" style="margin-left:35px;margin-top: 28px;">
                <div class="afal_title1" > <span>*</span>标题：</div>
                <div class="afal_content1 aus_content3" style="border:0px solid red;width: 330px;">
                  <el-input v-model="obj.multiMediaTitle" placeholder="请输入标题" style="width: 330px;" clearable></el-input>
                </div>
              </div>

              <div class="afal_line1"  v-if="obj.multiMediaType=='1'" style="margin-left:35px;margin-top: 28px;">
                <div class="afal_title1" >描述：</div>
                <div class="afal_content1 aus_content3" style="border:0px solid red;width:330px;">
                  <el-input v-model="obj.multiMediaDescribe" placeholder="请输入描述" style="width: 330px;" clearable type="textarea" :rows="2"></el-input>
                </div>
              </div>

              <div class="afal_line1" style="margin-left:35px;margin-top: 28px;">
                <div class="afal_title1" v-if="obj.multiMediaType=='1'"> <span>*</span>图片：</div>
                <div class="afal_title1" v-else> <span>*</span>附件：</div>
                <div class="afal_content1 aus_content3" style="border:0px solid red;width: 330px;">

                  <div v-if="obj.multiMediaType=='1' && obj.multiMediaImgUrl_comfile.length>0" style="margin-bottom: 20px;">
                    <div style="display: flex;align-items: center;justify-content: flex-start;flex-direction: row;margin-bottom: 10px;"  v-for="(item,index) in obj.multiMediaImgUrl_comfile">
                      <img
                        :src="webUrl(item.fileSrc)" style="max-width:150px;"  class="aus_upfile_bg">
                      <i @click="removeImg(index)" class="el-icon-error" style="width: 20px;height: 20px;color:red;display: flex;align-items: center;justify-content: center;margin-left: 20px;cursor: pointer;"></i>
                    </div>

                  </div>

                  <el-upload
                    style="width: 162px;float: left;margin-left: 0px;"
                  ...
                  >
                    ...
                    <div v-if="obj.multiMediaType=='1' " class="afal_line1_upfile_add" style="width: 66px;">
                      <div style="width: 100%;display: flex;justify-content: center;">
                        <div   style="width: 12px;height: 12px;background-size: 99%;background-repeat: no-repeat;margin-top: 5px;" :style="{backgroundImage:'url(' + imghost + '/personalCenter/pcCourseSource/pcCourseSource_uploadFile_jia.png' + ')' }"></div>
                      </div>
                    </div>


                    <div v-if="(obj.multiMediaType=='2' && obj.multiMediaImgUrlAudio=='' ) ||  (obj.multiMediaType=='3' && obj.multiMediaImgUrlVideo=='' ) " class="afal_line1_upfile_add">
                      <div style="color: #00BDA5;font-size: 20px;"><i class="el-icon-circle-plus"></i></div>
                      <div style="color: #252525;margin-left: 12px;">添加附件</div>
                    </div>

                    <audio v-if="obj.multiMediaType=='2' && obj.multiMediaImgUrlAudio!=''" controls  loop controlsList="nodownload" oncontextmenu="return false">
                      <source :src="webUrl(obj.multiMediaImgUrlAudio)" type="audio/mpeg">
                      您的浏览器不支持 audio 元素。
                    </audio>

                    <video v-if="obj.multiMediaType=='3' && obj.multiMediaImgUrlVideo!=''" class="aus_upfile_bg" style="object-fit:fill;width: 200px;height: 200px;background-size: 99%;background-repeat: no-repeat;display: flex;justify-content: center;flex-direction: column;margin-top: 0px;"  :src="webUrl(obj.multiMediaImgUrlVideo)"  />
